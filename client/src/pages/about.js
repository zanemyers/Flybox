...
export default function About() {
    return (<div className="container">
      ...
      <AboutSection img={idea} alt="Idea Illustration" url="https://www.freepik.com" attribution="Designed by Dooder / Freepik" heading="Where the Idea Came From">
        <p>
      ...
      <AboutSection img={important} alt="Important Illustration" url="https://www.freepik.com" attribution="Designed by Dooder / Freepik" heading="Why It Matters" reverse={true}>
        <p>
      ...
      <AboutSection img={serve} alt="Serve Illustration" url="https://www.freepik.com" attribution="Designed by Dooder / Freepik" heading="Who We Serve">
        <p>
      ...
      <section className="mb-5 pt-5">
        ...
        <div className="row g-4 text-center">
          ...
          <Card icon="🎣" title="ShopReel" description="ShopReel scrapes business data from Google Maps and shop websites, compiling key details into a structured Excel file." link="/docs?tab=ShopReel" buttonText="Read More"/>
          {/* FishTales: Consolidates fishing reports into AI-generated summaries */}
          <Card icon="🐟" title="FishTales" description="FishTales parses and consolidates fishing reports from multiple websites into structured, AI-generated summaries." link="/docs?tab=FishTales" buttonText="Read More"/>
          {/* SiteScout: Compares ShopReel and FishTales data to find new spots */}
          <Card icon="🗺" title="SiteScout" description="SiteScout compares the ShopReel and FishTales files to find new fishing spots." link="/docs?tab=SiteScout" buttonText="Read More"/>
        </div>
      </section>
    </div>);
}
